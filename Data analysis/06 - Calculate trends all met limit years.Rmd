...
summer_vhod <- sen_slope_custom(all_data %>% filter(!is.na(DO_demand_mgLd)), "DO_demand_mgLd")
...
write.csv(summer_vhod, "../Compiled data/summer_vhod_trends_3m.csv", row.names = F)
```
...
climate_era5 = read.csv("../Compiled data/historical_met_output_era5_daily.csv") %>%
  mutate(Date = as.Date(Date),
         Date_unif = ifelse(Lat > 0, Date, Date + months(6)),
