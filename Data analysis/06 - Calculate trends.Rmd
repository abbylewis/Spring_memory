...
mean_sen <- sen_slope_custom(all_data %>% filter(!is.na(Temp_C_HYPO)), "Temp_C_HYPO")
summer_mean_sen <- sen_slope_custom(all_data %>% filter(!is.na(Temp_C_HYPO)), "Temp_C_HYPO")
epi_sen <- sen_slope_custom(all_data %>% filter(!is.na(Temp_C_EPI)), "Temp_C_EPI")
...
hypo_tp_sen <- sen_slope_custom(all_data %>% filter(!is.na(TP_ugL_HYPO)), "TP_ugL_HYPO")
epi_tp_sen <- sen_slope_custom(all_data %>% filter(!is.na(TP_ugL_EPI)), "TP_ugL_EPI")
