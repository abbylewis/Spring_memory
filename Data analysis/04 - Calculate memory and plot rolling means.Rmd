...
This file calculates "seasonal ecological memory" as the maximum
absolute correlation between our summer focal variables and 30-day
rolling mean air temperature during July--August (summer) minus the
maximum correlation during spring (March-May).
...
What dates are most correlated within the windows we assigned? How do
these relate to stratification onset?
