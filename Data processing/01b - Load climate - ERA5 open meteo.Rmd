...
This script loads climate data from the ERA5 re-analysis data product through ROpenMeteo. I am not using this code currently, but it would allow you to look at meteorological drivers other than temperature.

The output of this file is too large to store on GitHub, so data would need to be re-processed for replication. 
