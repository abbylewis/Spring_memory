...
fm1 <- lm(hypo_temp ~ log_SA*log_max_depth*spring_temp*summer_temp+winter_temp,
          data = for_lm_df,
          na.action = "na.fail")
dd <- MuMIn::dredge(fm1)
subset(dd, delta < 2)
...
mod_lm <- lm(hypo_temp~spring_temp + summer_temp + log_SA + log_max_depth+
               ...
               log_max_depth:log_SA:summer_temp + log_SA:spring_temp:summer_temp, data = std_data) 
mod_lm <- lm(hypo_temp~spring_temp + summer_temp + log_SA + log_max_depth, data = std_data) 
car::vif(mod_lm)
summary(mod_lm)
