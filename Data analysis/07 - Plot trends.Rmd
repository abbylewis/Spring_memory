...
temp_plot <- ggarrange(air_trends_wide_blank,
          hypo_trends +
            ...
            stat_regline_equation(label.y = 0.4, label.x = -0.06) +
            geom_text(aes(x = -0.06, y = 0.3, label = p_val), data = p_vals, hjust = 0)+
            ylim(c(-0.61, 0.45)),
...
jpeg("../Figures/Temp_trends_by_season_reg_DO.jpeg", width = 6, height = 6, units = "in", res = 300)
ggarrange(ggarrange(air_trends_wide_blank,
          ...
          hypo_trends_do +
            ...
            stat_regline_equation(label.y = 0.43, label.x = -0.06) +
            geom_text(aes(x = -0.06, y = 0.35, label = p_val), data = p_vals_do, hjust = 0)+
            ylim(c(-0.35, 0.45))+
            theme(strip.text = element_blank()),
          align = "v", ncol = 1, heights = c(1.2, 1))
dev.off()
```
