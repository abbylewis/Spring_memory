...
To download ERA 5 hourly data: 
https://cds-beta.climate.copernicus.eu/datasets/reanalysis-era5-single-levels?tab=download
(note: Need to do this in batches to accommodate download size limits)

  Product type: Reanalysis
  Variable: 10m u-component of wind, 10m v-component of wind, Surface solar radiation downwards
  Year: 1980-2022
  Month: all
  Day: all
  Time: all
  Geographical Area: -43 to 70 lat, -123 to 177 lon (to match with lake locations)
