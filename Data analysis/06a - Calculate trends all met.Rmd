...
write.csv(summer_epi_sen, "../Compiled data/summer_epi_temp_trends_3m.csv", row.names = F)
write.csv(summer_mean_sen, "../Compiled data/summer_hypo_temp_mean_trends_3m.csv", row.names = F)
write.csv(summer_do_sen, "../Compiled data/summer_hypo_DO_trends_3m.csv", row.names = F)
```
...
#Save output
write.csv(temp_era5_trends %>% full_join(wind_era5_trends) %>% full_join(light_era5_trends), 
